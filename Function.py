...
class Function:
    ...
    in R1. This class is inspired at rocketpy.Function.'''
    def __init__(self, X, Y=None, xlabel = "Abscissas", ylabel = "Ordenadas", name=None, intervalo=[0, 10], method="linear"):
        ...
        self.__X_source__label = xlabel
        self.__Y_source__label = ylabel
        self.name = name
    ...
    def plot2D(self, title='', lower=None, upper=None, export=False, xscale="linear", yscale="linear", display=True, style=False):
        ...
        plt.plot(X, Y)
        plt.xlabel(self.__X_source__label, fontsize=14)
        plt.ylabel(self.__Y_source__label, fontsize=14)
    ...
    def plot2D2(self, title='', lower=None, upper=None, export=False, display=True):
        ...
        fig.update_layout(title=title,
                   xaxis_title=self.__X_source__label,
                   yaxis_title=self.__Y_source__label)
        if type(export) == bool:
            if export:
